 $(document).ready(function(){
		...
		if ($("#popUP").children().length == 0) {
  			...
  			$(".nightview").attr("class", "nightview fas fa-moon");
  			}
  		else {

			$(".nightview").attr("class", "nightview");
  			}
  		};
		...
		function NightMode(){
			if ($(".nightview").attr("class") == "nightview fas fa-moon") {
					$(".nightview").attr("class", "nightview far fa-moon");
					$(".ArticleBody").css("background-color", "#333");
					$(".ArticleBody").css("color", "#ffffff");
 		}
 			else if ($(".nightview").attr("class") == "nightview far fa-moon") {
 					$(".nightview").attr("class", "nightview fas fa-moon");
